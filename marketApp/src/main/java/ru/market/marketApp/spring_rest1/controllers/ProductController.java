package ru.market.marketApp.spring_rest1.controllers;
...
import ru.market.marketApp.spring_rest1.services.CategoryService;
import ru.market.marketApp.spring_rest1.services.ProductService;
...
public class ProductController {
    ...
    public Page<ProductDto> findByAll(@RequestParam(name = "p", defaultValue = "1") int pageIndex) {
        return productService.findByAll(pageIndex - 1, 10).map(ProductDto::new);
    }
